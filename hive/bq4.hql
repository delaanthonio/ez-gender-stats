-- Female Employment
DROP TABLE IF EXISTS BQ4_SOLUTION;

CREATE EXTERNAL TABLE BQ4_SOLUTION
(
COUNTRY_NAME STRING
, `2000-01` DOUBLE
, `2001-02` DOUBLE
...
LINES TERMINATED BY '\n'
LOCATION '/user/cloudera/Project2/hive/tables/BQ4_SOLUTION/';

-- Female employment change since 2000
INSERT OVERWRITE TABLE BQ4_SOLUTION
SELECT COUNTRY_NAME,
